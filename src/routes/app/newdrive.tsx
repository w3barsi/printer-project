...
const folders = [
  { name: "Brand assets", detail: "18 items", shared: true },
  { name: "Client proofs", detail: "42 items", shared: true },
  { name: "Production files", detail: "27 items", shared: false },
  { name: "Team resources", detail: "11 items", shared: true },
];
...
function NewDrivePage() {
  ...
  return (
    <Container
      className="max-w-7xl space-y-6 px-3 py-5 md:px-6 md:py-7"
        ...
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 xl:grid-cols-4">
          {folders.map((folder) => (
            <button
              key={folder.name}
              type="button"
              className="group flex min-w-0 items-center gap-3 rounded-lg border bg-card p-3 text-left shadow-xs transition-[border-color,background-color,box-shadow] hover:border-blue-300 hover:bg-blue-50/40 hover:shadow-sm focus-visible:ring-3 focus-visible:ring-blue-500/25 focus-visible:outline-none dark:hover:border-blue-800 dark:hover:bg-blue-950/20"
            >
              <span className="flex size-10 shrink-0 items-center justify-center rounded-md bg-blue-50 text-blue-700 dark:bg-blue-950/60 dark:text-blue-400">
